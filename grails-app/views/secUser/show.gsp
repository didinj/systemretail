...
<%@ page import="com.djamware.SecUser" %>
<!doctype html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-secUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list secUser">
				...
				<li class="fieldcontain">
					<span id="fullname-label" class="property-label"><g:message code="secUser.fullname.label" default="Fullname" /></span>
				...
				<g:if test="${secUserInstance?.departement}">
				<li class="fieldcontain">
					<span id="departement-label" class="property-label"><g:message code="secUser.departement.label" default="Departement" /></span>
					
						<span class="property-value" aria-labelledby="departement-label"><g:fieldValue bean="${secUserInstance}" field="departement"/></span>
