...
<div class="fieldcontain ${hasErrors(bean: secUserInstance, field: 'departement', 'error')} ">
	<label for="departement">
		<g:message code="secUser.departement.label" default="Departement" />
		
	</label>
	<g:textField name="departement" value="${secUserInstance?.departement}"/>
</div>
